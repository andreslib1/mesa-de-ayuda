...
<style>
    ...
    <h3 class="p-2 p-sm-4 display-5" style="font-size: 30px;"  >
        ...
        <a style="text-decoration: none;" id="etiqueta_pri" href="">/Historial casos atendidos</a></h3>        
                                 ...
                                 echo "<tr class='text-center align-middle' style='border-bottom: solid 1px rgba(149, 157, 165, 0.1);'>
                                          ...
                                          <td>
                                            <form method='POST' class=''>
                                                <div id='eye'>
                                                <a  href='historial_gen_c.php?cod_caso=".$row['COD_CASO']."&cod_user_tecnico=".$user."'><i class='bi bi-eye custom-icon'></i></a></div>
                                               </td>
                                            </form>
                                           </tr>";
                                        }     

...
<style>
    ...
    <h3 class="p-2 p-sm-4 display-5" style="font-size: 30px;"  >
        ...
        <a style="text-decoration: none;" id="etiqueta_pri" href="">/Historial Casos solicitados</a></h3>     
       <div class="justify-content-center row">
        <div class="col-11 mt-3 mb-5 row justify-content-center" style="box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px; border-radius: 15px; " id="tables">
...
<?php  
                ...
                $consult = "SELECT * FROM baseuno.casos 
                                ...
                                AND encuesta.CALIFICACION IS NOT NULL";
                                 ...
                                 echo "<tr class='text-center align-middle' style='border-bottom: solid 1px rgba(149, 157, 165, 0.1);'>
                                          ...
                                          <td>
                                            <form method='POST' class=''>
                                                <div id='eye'>
                                                <a  href='historial_gen_c.php?cod_caso=".$row['COD_CASO']."'><i class='bi bi-eye custom-icon'></i></a></div>
                                               </td>
                                            </form>
                                           </tr>";
                                        }     

...
<style>
    ...
    <h3 class="p-2 p-sm-4 display-5" style="font-size: 30px;"  >
        ...
        <a style="text-decoration: none;" id="etiqueta_pri" href="">/Casos generados</a></h3> 
    <div class="justify-content-center row">
    
        <div class="col-9 mt-2 mt-sm-5 mb-5 row justify-content-center" style="box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px; border-radius: 15px;" id="tables">
...
<?php  
                                 ...
                                 echo "<tr class='text-center align-middle' style='border-bottom: solid 1px rgba(149, 157, 165, 0.1);'>
                                          ...
                                          <td>
                                            <form method='POST' class=''>
                                                <div id='eye'>
                                                <a  href='seguimiento.php?cod_caso=".$row['COD_CASO']."&cod_user_solicita=".$user."'><i class='bi bi-eye custom-icon'></i></a></div>
                                               </td>
                                            </form>
                                           </tr>";
                                        }     
 ...
 ?>                    
       ...
       <div class="col-9 col-sm-10 mt-5 mb-5 row justify-content-center" style="box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px; border-radius: 15px; " id="tables">
       <h3 class="p-4 display-5" style="font-size: 30px;" >Casos pendientes por evaluar</h3>
<?php  
                ...
                $consult = "SELECT * FROM baseuno.casos
                            ...
                            AND encuesta.CALIFICACION IS NULL";
